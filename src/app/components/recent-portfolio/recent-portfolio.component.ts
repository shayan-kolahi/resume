...
@Component({
  selector: 'app-recent-portfolio',
  templateUrl: './recent-portfolio.component.html',
  styleUrls: ['./recent-portfolio.component.scss']
})
export class RecentPortfolioComponent implements OnInit {
